  ...
  h(a, "mixins/download-url.js", [a["parts/Globals.js"]], function (a) {
    ...
    a.dataURLtoBlob = function (a) {
      if (
        ...
        for (var e = 0; e < d.length; ++e) d[e] = g.charCodeAt(e);
  ...
  h(
    ...
    function (a, b, h, k) {
      ...
      b.svgToDataUrl = function (a) {
        var b =
          -1 < x.userAgent.indexOf("WebKit") &&
          0 > x.userAgent.indexOf("Chrome");
        try {
          if (!b && 0 > x.userAgent.toLowerCase().indexOf("firefox"))
            return D.createObjectURL(
              new e.Blob([a], { type: "image/svg+xml;charset-utf-16" })
            );
        } catch (f) {}
      ...
      b.downloadSVGLocal = function (a, d, f, c) {
        ...
        else if ("application/pdf" === l)
          e.jsPDF && e.svg2pdf
            ? m()
            : ((k = !0),
              n(t + "jspdf.js", function () {
            ...
            function () {
              var d = g.createElement("canvas"),
                ...
                p = function () {
                  ...
                  try {
                    b.downloadURL(
                      x.msSaveOrOpenBlob ? d.msToBlob() : d.toDataURL(l),
                      r
                    ),
                      c && c();
                  } catch (I) {
      ...
      a.prototype.getSVGForLocalExport = function (a, e, d, c) {
        ...
        try {
          ...
          for (k = w.length; p < k; ++p) {
            var v = w[p];
            (l = v.getAttributeNS("http://www.w3.org/1999/xlink", "href"))
              ? b.imageToDataUrl(
                  l,
                  "image/png",
                  { imageElement: v },
              ...
              : (++m, v.parentNode.removeChild(v), r());
          }
        } catch (y) {
          d(y);
        }
      ...
      a.prototype.exportChartLocal = function (a, e) {
        ...
        a = function () {
          return [].some.call(
            f.container.getElementsByTagName("image"),
            function (a) {
        ...
        (B &&
          ("application/pdf" === c.type ||
            (f.container.getElementsByTagName("image").length &&
              "image/svg+xml" !== c.type))) ||
        ("application/pdf" === c.type && a())
          ? g("Image type not supported for this chart/browser.")
          : f.getSVGForLocalExport(c, e, g, function (a) {
              -1 < a.indexOf("<foreignObject") && "image/svg+xml" !== c.type
                ? g("Image type not supportedfor charts with embedded HTML")
                : b.downloadSVGLocal(a, F({ filename: f.getFilename() }, c), g);
            });
      };
      C(!0, A().exporting, {
