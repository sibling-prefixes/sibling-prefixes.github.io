    ...
    function (a, b) {
      ...
      a.ajax = function (b) {
        ...
        a.headers["Content-Type"] ||
          c.setRequestHeader("Content-Type", b[a.dataType] || b.text);
    ...
    function (a, b, e, d) {
      function f(a, b) {
        ...
        try {
          ...
          if (!d)
            return g.createObjectURL(new p.Blob(["\ufeff" + a], { type: b }));
        } catch (M) {}
      }
      var u = e.doc,
        c = e.seriesTypes,
      ...
      b.prototype.getDataRows = function (b) {
        ...
        var z = k.categoryHeader,
          ...
          G = function (n, c, d) {
            ...
            return n
              ? n instanceof a
                ? (n.options.title && n.options.title.text) ||
                  (n.dateTime ? x : z)
                : b
                ? {
            ...
            a.options.data.forEach(function (b, g) {
              ...
              for (q[b].xValues[z] = h.x; k < f; )
                (g = n[k]),
                  ...
                  (q[b][y + k] = w(
                    C.categoryMap[g][r],
                    C.dateTimeValueAxisMap[g]
                      ? d.dateFormat(e.dateFormat, r)
                      : null,
                    r
                  )),
                  k++;
        ...
        for (l in q) Object.hasOwnProperty.call(q, l) && f.push(q[l]);
        var l = b ? [p, t] : [t];
        for (y = h.length; y--; ) {
          var u = h[y][0];
          var v = h[y][1];
          ...
          f.forEach(function (a) {
            ...
            A &&
              ...
              (A.dateTime
                ...
                : (b = A.categories
                    ? w(A.names[a.x], A.categories[a.x], a.x)
                    : a.x));
            a.splice(v, 0, b);
          });
        }
      ...
      b.prototype.downloadCSV = function () {
        var a = this.getCSV(!0);
        F(
          f(a, "text/csv") || "data:text/csv,\ufeff" + encodeURIComponent(a),
      ...
      b.prototype.viewData = function () {
        this.dataTableDiv ||
          ((this.dataTableDiv = u.createElement("div")),
      ...
      if ((b = K().exporting))
        E(b.menuItemDefinitions, {
          ...
          b.buttons &&
            b.buttons.contextButton.menuItems.push(
              "separator",
              "downloadCSV",
              "downloadXLS",
              "viewData"
